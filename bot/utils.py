...
def display_stats(game_record,games_len, starter, seconder):
    starter_wins = 0
    seconder_wins = 0
    draw = 0
    ...
    print(
        f"{starter} vyhralo {100 * starter_wins / len(game_record)}%, {seconder}vyhral {100 * seconder_wins / len(game_record)}% a remizovali {100 * draw / len(game_record)}%")
